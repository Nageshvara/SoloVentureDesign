        ...
        {items.map((item, idx) => (
          ...
          >
            <blockquote>
              ...
              ></div>
              <span className="relative z-20 text-lg leading-[1.6] text-[#171717] font-normal">
                {item.quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                ...
                <span className="flex flex-col gap-1">
                  <span className="text-sm leading-[1.6] text-[#171717] font-bold">
                    {item.name}
                  </span>
                  <span className="text-sm leading-[1.6] text-[#171717] font-normal">
                    {item.title}
                  </span>
                </span>
              </div>
